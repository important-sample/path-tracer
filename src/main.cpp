...
int main()
{
  ...
  std::shared_ptr<BaseMaterial> sphereMaterial = std::make_shared<TexturedMaterial>(sphereTexture, 0.81f);
  ...
  scene.addObject(std::make_shared<Sphere>(Vector(-0.8f, -0.5f, 0.8f), 0.5f, sphereMaterial));
  scene.addObject(std::make_shared<Sphere>(Vector(0.6f, -0.5f, 0.3f), 0.5f, sphereMaterial));
